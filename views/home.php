...
<div class="horizontal-scroll">
    ...
    <div class="item" id="desciption">
        <h2 id="desciptiontitle">Hello World!</h2>
        <br>
        <p id="desciption2">Hello there, Welcome to my website. <br> I am a developer, producer and graphic designer and <br> this
            website was made
    ...
    <div class="item">
        <img src="../static/assets/images/damnbirddodo.png" alt="Damn">
        <nav class="navbar">
